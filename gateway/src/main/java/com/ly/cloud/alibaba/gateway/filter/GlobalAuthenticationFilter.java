...
import com.ly.cloud.alibaba.gateway.model.TokenConstant;
...
public class GlobalAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private Mono<Void> invalidTokenMono(ServerWebExchange exchange) {
        final APIResponse<Object> apiResponse = APIResponse.builder()
                .code(SystemErrorCoeEnum.UNAUTHORIZED.getCode())
                .msg(SystemErrorCoeEnum.UNAUTHORIZED.getMsg())
                .build();
        return buildReturnMono(apiResponse, exchange);
    }

    private Mono<Void> buildReturnMono(APIResponse resultMsg, ServerWebExchange exchange) {
